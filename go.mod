...
require (
	github.com/lightstep/otel-launcher-go v1.13.1
...
require (
	...
	github.com/lightstep/otel-launcher-go/lightstep/sdk/metric v1.13.1 // indirect
	github.com/lightstep/otel-launcher-go/pipelines v1.13.1 // indirect
