...
require (
	github.com/lightstep/otel-launcher-go v1.17.0
...
require (
	...
	github.com/lightstep/otel-launcher-go/lightstep/instrumentation v1.17.0 // indirect
	github.com/lightstep/otel-launcher-go/lightstep/sdk/metric v1.17.0 // indirect
	github.com/lightstep/otel-launcher-go/pipelines v1.17.0 // indirect
