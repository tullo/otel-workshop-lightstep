...
require (
	github.com/lightstep/otel-launcher-go v1.23.0
...
require (
	...
	github.com/lightstep/otel-launcher-go/lightstep/sdk/metric v1.23.0 // indirect
	github.com/lightstep/otel-launcher-go/pipelines v1.23.0 // indirect
